...
const PaymentPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Update user subscription (in real app, this would happen after admin verification)
      dispatch(updateCredits(user!.credits + selectedPlan.credits));
      dispatch(
        updateSubscription({
          plan: selectedPlan.name,
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          ...
                          <div className="flex items-center justify-between p-3 bg-white rounded-lg">
                            ...
                            <Button
                              ...
                              size="sm"
                              onClick={() =>
                                handleCopy(paymentDetails.bank.ifscCode, "ifsc")
                              }
                              className={
                                copied === "ifsc"
                                  ? "bg-green-100 text-green-700"
                          ...
                          <div className="flex items-start space-x-2">
                            ...
                            <div>
                              <p className="text-sm text-yellow-800">
                                ...
                                will be activated within 24 hours after payment
                                verification. You will receive a confirmation
                                email once activated.
                              </p>
                            </div>
                          </div>
                        </div>

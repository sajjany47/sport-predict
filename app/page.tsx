...
import { Star, Trophy, Target, BarChart3, Users, Shield, ChevronRight, Play } from 'lucide-react';
...
const HomePage = () => {
  ...
  const customerReviews = [
    {
      name: 'Rahul Sharma',
      rating: 5,
      comment: 'Amazing predictions! Won multiple Dream11 contests using SportPredict AI insights.',
      avatar: 'RS',
    },
    {
      name: 'Priya Patel',
      rating: 5,
      comment: 'The player analytics are incredibly detailed. Best fantasy cricket platform!',
      avatar: 'PP',
    },
    {
      name: 'Amit Kumar',
      rating: 4,
      comment: 'Great accuracy in match predictions. The Dream11 team suggestions work perfectly.',
      avatar: 'AK',
    },
  ];
  ...
  const services = [
    {
      ...
      description: 'Advanced AI algorithms analyze team performance, player form, and weather conditions for accurate predictions.',
    },
    {
      icon: Trophy,
      title: 'Dream11 Team Builder',
      description: 'Get optimized team combinations with captain and vice-captain suggestions based on recent form.',
    },
    {
      icon: BarChart3,
      title: 'Player Analytics',
      description: 'Comprehensive player statistics including recent form, head-to-head records, and venue performance.',
    },
    {
      icon: Shield,
      title: 'Secure & Reliable',
      description: '99.9% uptime with bank-grade security. Your data and payments are completely secure with us.',
    },
  ];
  ...
  const subscriptionPlans = [
    ...
    },
    {
      ...
      price: 299,
      credits: 50,
      features: ['50 Monthly Credits', 'Advanced AI Predictions', 'Detailed Analytics', 'Priority Support'],
      popular: true,
    },
    {
      name: 'Elite',
      price: 599,
      credits: 150,
      features: ['150 Monthly Credits', 'Premium AI Insights', 'Complete Database', 'VIP Support'],
      popular: false,
    },
  ];
        ...
        <div className="relative container mx-auto px-4 py-20">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
              ...
              <br />Cricket Predictions
            </h1>
            <p className="text-xl md:text-2xl mb-8 text-blue-100 max-w-3xl mx-auto leading-relaxed">
              Get accurate match predictions and optimized Dream11 team suggestions powered by advanced AI algorithms.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="bg-gradient-to-r from-orange-500 to-red-600 hover:from-orange-600 hover:to-red-700 text-white px-8 py-3 text-lg font-semibold transform hover:scale-105 transition-all duration-200">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Join thousands of satisfied users who are winning big with our AI predictions
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {subscriptionPlans.map((plan, index) => (
              <Card key={index} className={`relative ${plan.popular ? 'ring-2 ring-blue-600 shadow-xl scale-105' : 'shadow-lg'} border-0`}>
                {plan.popular && (
                ...
                <CardContent className="p-8 text-center">
                  ...
                  <div className="mb-6">
                    <div className="text-3xl font-bold text-gray-900">{plan.credits}</div>
                    <div className="text-gray-600">Credits {plan.price === 0 ? 'Daily' : 'Monthly'}</div>
                  </div>
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl mb-8 text-blue-100">
              Join thousands of cricket fans who trust SportPredict for their fantasy league success
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
